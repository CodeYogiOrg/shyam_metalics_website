...
export default function Aluminium() {
  return (
    <div className="pt-24">
      {/* Hero */}
      <WaveSection waves={4} className="relative h-[921px] flex items-center overflow-hidden">
        ...
        <div className="container mx-auto px-6 md:px-12 relative z-10">
          <div className="max-w-4xl">
            <AnimatedSection delay={0.2}>
              <span className="font-label text-[#C3D809] tracking-[0.3em] uppercase text-sm mb-6 block">Industrial Excellence Refined</span>
            </AnimatedSection>
            ...
            <AnimatedSection delay={0.8}>
              <div className="flex gap-6">
                <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="px-8 py-4 molten-gradient text-[#1a1c00] font-bold rounded-lg flex items-center gap-3">
            ...
            <StaggerItem className="md:col-span-8">
              <motion.div whileHover={{ y: -5 }} className="group relative overflow-hidden rounded-xl bg-surface-container-high h-full">
                ...
                <div className="absolute bottom-0 p-12 w-full">
                  <span className="bg-[#C3D809] text-[#1a1c00] text-[10px] font-black px-3 py-1 rounded-full mb-4 inline-block tracking-tighter uppercase">Flagship Brand</span>
            ...
            <StaggerItem className="md:col-span-4">
              <motion.div whileHover={{ y: -5 }} className="group relative overflow-hidden rounded-xl bg-surface-container-high h-full">
                ...
                <div className="absolute bottom-0 p-8">
                  ...
                  <span className="material-symbols-outlined text-[#C3D809] text-4xl">ev_station</span>
                </div>
              </motion.div>
            </StaggerItem>
            <StaggerItem className="md:col-span-4">
              <motion.div whileHover={{ y: -5 }} className="group relative overflow-hidden rounded-xl bg-surface-container-high h-full">
                ...
                <div className="absolute bottom-0 p-8">
                  ...
                  <span className="material-symbols-outlined text-[#C3D809] text-4xl">ac_unit</span>
                </div>
              </motion.div>
            </StaggerItem>
            <StaggerItem className="md:col-span-8">
                ...
                <div className="relative p-12 h-full flex flex-col justify-end">
                  ...
                  <div className="flex flex-wrap gap-4 mb-8">
                    {['PTP Foil', 'Blister Packaging', 'Cold Form'].map((t) => (
                      <span key={t} className="px-4 py-2 bg-surface-container-highest border border-[#C3D809]/10 rounded-full font-label text-xs uppercase tracking-widest text-on-surface">{t}</span>
                    ))}
                  </div>
      ...
      {/* Technical */}
      <WaveSection waves={3} className="py-32 px-6 md:px-12 overflow-hidden relative">
        <div className="max-w-[1920px] mx-auto grid md:grid-cols-2 gap-24 items-center">
          <AnimatedSection direction="left">
            <h2 className="font-headline text-5xl font-black tracking-tighter mb-8">ENGINEERED TO <br /><span className="text-[#C3D809]">MICRON PRECISION</span></h2>
            ...
            <div className="space-y-8">
              <div className="flex gap-6 items-start">
                <div className="w-12 h-12 flex-shrink-0 bg-surface-container-high rounded-lg flex items-center justify-center text-[#C3D809]">
          ...
          <AnimatedSection direction="right">
            <div className="relative">
              ...
              <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="absolute -bottom-10 -left-10 bg-black/80 backdrop-blur-xl p-8 rounded-xl border border-[#C3D809]/20 max-w-[280px]">
                <div className="text-5xl font-black text-[#C3D809] mb-2">40k+</div>
      ...
      <section className="py-24 px-6 md:px-12 bg-surface">
        <AnimatedSection>
          <div className="max-w-[1920px] mx-auto bg-gradient-to-br from-surface-container-high to-[#222022] p-16 rounded-3xl border border-[#C3D809]/10 relative overflow-hidden">
            <div className="relative z-10 max-w-2xl">
              ...
              <div className="flex flex-wrap gap-4">
                <motion.button whileHover={{ scale: 1.05, backgroundColor: '#C3D809', color: '#1a1c00' }} whileTap={{ scale: 0.95 }} className="px-8 py-4 bg-white text-black font-bold uppercase tracking-tighter rounded transition-colors">Request a Quote</motion.button>

    ...
    <div className="bg-mesh">
      ...
      <section className="relative h-screen flex items-center px-6 md:px-12 pt-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl">
          <AnimatedSection delay={0.2}>
            <span className="font-label text-[#0145F2] tracking-[0.3em] uppercase text-xs mb-4 block">Industrial Excellence</span>
          </AnimatedSection>
          <AnimatedSection delay={0.4}>
            <h1 className="font-headline text-[clamp(3rem,8vw,6rem)] font-black leading-[0.9] tracking-tighter text-slate-800 mb-8">
              STAINLESS <br /> <span className="text-[#0145F2] text-glow">REDEFINED.</span>
            </h1>
          </AnimatedSection>
          ...
          <AnimatedSection delay={0.8}>
            <div className="mt-12 flex space-x-6">
              <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="molten-gradient text-[#FFFFFF] px-8 py-4 rounded-md font-bold tracking-tight">View Product Range</motion.button>
      ...
      <section className="px-6 md:px-12 py-32 bg-surface-container-lowest">
        <div className="max-w-[1920px] mx-auto">
          <AnimatedSection>
            <h2 className="font-headline text-5xl font-black tracking-tighter text-slate-800 mb-4 uppercase">The Core Portfolio</h2>
          ...
          <StaggerContainer className="grid grid-cols-1 md:grid-cols-12 gap-6" staggerDelay={0.1}>
            <StaggerItem className="md:col-span-8">
              <motion.div whileHover={{ y: -5 }} className="group relative overflow-hidden bg-surface-container-high rounded-xl h-[500px]">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent p-10 flex flex-col justify-end">
                  <span className="font-label text-[#0145F2] text-xs tracking-widest uppercase mb-2">Primary Casting</span>
                  <h3 className="text-4xl font-black text-white tracking-tighter mb-4">STAINLESS STEEL BILLETS</h3>
                  <p className="max-w-md text-slate-300 opacity-0 group-hover:opacity-100 transition-opacity duration-500">The foundation of quality. Our billets offer uniform grain structure and superior surface finish.</p>
                </div>
              </motion.div>
            </StaggerItem>
            <StaggerItem className="md:col-span-4">
              <motion.div whileHover={{ y: -5 }} className="group relative overflow-hidden bg-surface-variant/40 backdrop-blur-md rounded-xl h-[500px]">
                ...
                <div className="absolute inset-0 p-10 flex flex-col justify-between">
                  <div className="w-12 h-12 bg-[#0145F2]/10 rounded-full flex items-center justify-center border border-[#0145F2]/20">
                    <span className="material-symbols-outlined text-[#0145F2]">architecture</span>
                  </div>
                  <div>
                    <h3 className="text-3xl font-black text-white tracking-tighter mb-2">REBAR</h3>
                    <p className="text-slate-600 text-sm uppercase tracking-widest">Structural Reinforcement</p>
                  </div>
                </div>
              </motion.div>
            </StaggerItem>
            {[
              ...
              <StaggerItem key={p.title} className="md:col-span-4">
                <motion.div whileHover={{ y: -5, borderColor: 'rgba(1,69,242,0.3)' }} className="group relative overflow-hidden bg-surface-container-high rounded-xl h-[400px]">
      ...
      <section className="px-6 md:px-12 py-32 relative overflow-hidden">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-[#0145F2]/10 blur-[120px] rounded-full pointer-events-none"></div>
        <StaggerContainer className="max-w-7xl mx-auto relative z-10 grid grid-cols-1 lg:grid-cols-3 gap-12" staggerDelay={0.15}>
          <StaggerItem>
            <div className="bg-surface-variant/20 backdrop-blur-xl p-12 rounded-xl border border-white/5 h-full">
              <span className="font-label text-[#0145F2]/30 text-[4rem] font-black leading-none">01</span>
          ...
          <StaggerItem>
            <div className="bg-surface-variant/40 backdrop-blur-xl p-12 rounded-xl border border-[#0145F2]/20 scale-105 shadow-2xl h-full">
              <span className="font-label text-[#0145F2]/50 text-[4rem] font-black leading-none">02</span>
          ...
          <StaggerItem>
            <div className="bg-surface-variant/20 backdrop-blur-xl p-12 rounded-xl border border-white/5 h-full">
              <span className="font-label text-[#0145F2]/30 text-[4rem] font-black leading-none">03</span>
      ...
      {/* CTA */}
      <section className="py-40 bg-[#EDF1F5] text-center relative overflow-hidden">
        <div className="relative z-10 px-6">
          <AnimatedSection>
            <h2 className="font-headline text-5xl md:text-7xl font-black tracking-tighter mb-10 text-slate-800 uppercase">
              Partner with the <br /> <span className="text-[#0145F2] text-glow">Future of Steel.</span>
            </h2>
          </AnimatedSection>
          <AnimatedSection delay={0.2}>
            <div className="flex flex-col sm:flex-row justify-center items-center gap-6">
              <motion.button whileHover={{ scale: 1.05, backgroundColor: '#0145F2', color: '#FFFFFF' }} whileTap={{ scale: 0.95 }} className="px-10 py-5 bg-white text-black font-black uppercase tracking-widest text-sm transition-colors">Inquire Now</motion.button>
              <motion.button whileHover={{ scale: 1.05, borderColor: '#0145F2' }} whileTap={{ scale: 0.95 }} className="px-10 py-5 border border-slate-400 text-slate-800 font-black uppercase tracking-widest text-sm transition-colors">Catalog 2024</motion.button>
            </div>
          </AnimatedSection>
        </div>
      </section>

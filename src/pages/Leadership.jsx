...
export default function Leadership() {
  return (
    <div className="min-h-screen pt-32">
        ...
        <AnimatedSection>
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
            <div className="max-w-4xl">
              <span className="font-label text-[#C3D809] font-semibold tracking-[0.3em] uppercase block mb-4">Leadership</span>
              <h1 className="text-7xl md:text-9xl font-headline font-black tracking-tighter leading-none text-zinc-100">
                Architects of <span className="text-[#C3D809] italic">Growth</span>
              </h1>
            </div>
            <div className="md:w-1/3 pb-4">
              <p className="text-zinc-400 text-lg leading-relaxed border-l-2 border-[#C3D809]/30 pl-8">
      ...
      {/* Chairman */}
      <WaveSection waves={3} className="bg-surface-container-low py-32 relative overflow-hidden">
        <div className="max-w-[1920px] mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-12 gap-16 items-center">
          <AnimatedSection direction="left" className="md:col-span-7 z-10">
            <div className="inline-flex items-center gap-4 mb-8">
              <div className="h-[1px] w-12 bg-[#C3D809]"></div>
            ...
            <h2 className="text-5xl md:text-7xl font-headline font-extrabold text-zinc-100 mb-8 leading-tight">
              "The strength of steel is matched only by the <span className="text-[#C3D809]">clarity of purpose</span>."
            </h2>
            ...
            <div className="space-y-1">
              ...
              <p className="font-label text-[#C3D809] uppercase tracking-widest">Chairman & Founder</p>
            </div>
          </AnimatedSection>
          <AnimatedSection direction="right" className="md:col-span-5 relative">
            ...
            <div className="absolute -bottom-8 -left-8 w-48 h-48 border-l border-b border-[#C3D809]/20 -z-0"></div>
          </AnimatedSection>
        </div>
      </WaveSection>
      ...
      <section className="py-32 px-6 md:px-12 max-w-[1920px] mx-auto">
        ...
        <StaggerContainer className="grid grid-cols-1 md:grid-cols-4 gap-8" staggerDelay={0.1}>
          <StaggerItem className="md:col-span-2">
            <motion.div whileHover={{ y: -5, borderColor: 'rgba(195,216,9,0.15)' }} className="group relative overflow-hidden bg-surface-container-high p-10 rounded-xl transition-all duration-500 border border-transparent h-full">
              <div className="flex flex-col md:flex-row gap-8 items-start">
                <div className="w-32 h-32 flex-shrink-0 bg-surface-container-highest rounded-full overflow-hidden border-2 border-[#C3D809]/20">
                ...
                <div>
                  <span className="font-label text-[#C3D809] text-xs font-bold uppercase tracking-[0.2em] mb-2 block">Executive Vice Chairman</span>
                  <h3 className="text-3xl font-headline font-bold text-zinc-100 mb-4">Sheetal Agarwal</h3>
                  <p className="text-zinc-400 leading-relaxed mb-6">Pioneering the group's expansion into value-added products and international steel markets.</p>
                </div>
              </div>
            </motion.div>
          </StaggerItem>
          <StaggerItem>
            <motion.div whileHover={{ y: -5, borderColor: 'rgba(195,216,9,0.15)' }} className="group relative bg-surface-container-high p-8 rounded-xl transition-all duration-500 border border-transparent h-full">
              <div className="w-20 h-20 mb-6 bg-surface-container-highest rounded-full overflow-hidden border border-[#C3D809]/20">
                <img alt="Executive" className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-500" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCMbgaBaizRPSEepfZb6Y3jDRKN_s4QpYg4QLCso_4fKR3ioheH3G_wgTvHi348lzVLa85wLu2fwisx450KoqE3mcDx6ArsABUMHMSSgt45tzq3UT4gGUkWGj6uKip-3RNnM8awnCYTewsjS7IJ-7RxfTSZze0PO1DASXkdxGW51go-aA4Yv2byMtViO3ES42jdKd9HdMQ8ssUMY3eJ_7dJf7P04KPdDxO5Bqs0Zb5Ex8kGjFJ10lVQfpEZfTWpINpKstGasa-NnJE" />
              </div>
              <span className="font-label text-[#C3D809] text-xs font-bold uppercase tracking-[0.2em] mb-2 block">Managing Director</span>
              <h3 className="text-2xl font-headline font-bold text-zinc-100 mb-3">Dev Kumar Chowbey</h3>
              <p className="text-zinc-500 text-sm mb-6">Expertise in operational excellence and sustainable manufacturing processes.</p>
            </motion.div>
          </StaggerItem>
          <StaggerItem>
            <motion.div whileHover={{ y: -5, borderColor: 'rgba(195,216,9,0.15)' }} className="group relative bg-surface-container-high p-8 rounded-xl transition-all duration-500 border border-transparent h-full">
              ...
              <span className="font-label text-[#C3D809] text-xs font-bold uppercase tracking-[0.2em] mb-2 block">Independent Director</span>
              <h3 className="text-2xl font-headline font-bold text-zinc-100 mb-3">Ankita Sinha</h3>
              <p className="text-zinc-500 text-sm mb-6">Providing strategic oversight on corporate governance and financial integrity.</p>
            </motion.div>
          </StaggerItem>
        </StaggerContainer>
      </section>
      ...
      <section className="py-32 bg-surface-container-lowest">
        <div className="max-w-[1920px] mx-auto px-6 md:px-12">
          <AnimatedSection>
            <div className="mb-20">
              <span className="font-label text-[#C3D809] font-semibold tracking-[0.3em] uppercase block mb-4">The Engine Room</span>
              ...
              <StaggerItem key={m.name}>
                <div className="group">
                  <div className="relative mb-6 overflow-hidden aspect-square rounded-xl bg-surface-container-high">
                    ...
                    <div className="absolute inset-0 bg-[#C3D809]/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end p-6 backdrop-blur-[2px]">
                      <span className="text-[#1a1c00] font-label text-xs font-bold tracking-widest uppercase bg-[#C3D809] px-3 py-1">{m.dept}</span>
                    </div>
                  </div>
                  <h4 className="text-xl font-headline font-bold text-zinc-100 group-hover:text-[#C3D809] transition-colors">{m.name}</h4>
                  <p className="font-label text-zinc-500 text-sm uppercase tracking-widest mt-1">{m.role}</p>
                </div>
              </StaggerItem>
            ))}
          </StaggerContainer>
      ...
      <section className="py-24 px-6 md:px-12 text-center max-w-4xl mx-auto">
        <AnimatedSection>
          ...
          <p className="text-zinc-400 text-lg mb-10 leading-relaxed">Our leadership is dedicated to maintaining the highest standards of governance and operational integrity.</p>
          <div className="flex flex-wrap justify-center gap-6">
            <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="bg-[#C3D809] text-[#1a1c00] px-10 py-4 rounded-md font-bold tracking-widest uppercase shadow-xl shadow-[#C3D809]/10">Investor Relations</motion.button>
